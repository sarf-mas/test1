...
import static appjava.Appjava.CONN_STRING;
import static appjava.Appjava.PASSWORD;
import static appjava.Appjava.USERNAME;
        ...
        try {
          Connection  conn = DriverManager.getConnection(CONN_STRING, USERNAME, PASSWORD);
            ...
            System.out.println(PASSWORD);
             String sql = "insert into userinfo values ('"+t1+"', '"+t2+"')";
